...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem, Sendable {
    ...
    /**
     * Initializes the subsystem by starting the simulation thread and configuring the auto builder.
     */
    private void init() {
    ...
    public void periodic() {
        ...
        for (String limelightName : limelightNames) {
            ...
            if (mt2 != null && mt2.tagCount > 0 && getPigeon2().getAngularVelocityZDevice().getValueAsDouble() <= 720 && (mt2.avgTagArea > 0.5 || DriverStation.isDisabled())) {
                setVisionMeasurementStdDevs(VecBuilder.fill(0.25, 0.25, 9999999));
